...
-- gỡ các khóa ngoại
ALTER TABLE [FACT TABLE] DROP CONSTRAINT FK_WEATHER_LOCATION;

ALTER TABLE [FACT TABLE] DROP CONSTRAINT FK_WEATHER_WIND;

ALTER TABLE [FACT TABLE] DROP CONSTRAINT FK_WEATHER_DATE;
